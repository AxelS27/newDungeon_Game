...
public class MON_RedSlime extends Entity {
    ...
    public void getImage(){
        up1 = setup("/monsters/redslime_down_1");
        up2 = setup("/monsters/redslime_down_2");
        down1 = setup("/monsters/redslime_down_1");
        down2 = setup("/monsters/redslime_down_2");
        left1 = setup("/monsters/redslime_down_1");
        left2 = setup("/monsters/redslime_down_2");
        right1 = setup("/monsters/redslime_down_1");
        right2 = setup("/monsters/redslime_down_2");
    }
    ...
    public void setAction() {
        ...
        int chaseDistance = 20*gp.tileSize;
